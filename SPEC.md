...
> Last updated: 2026-03-24 (PM audit #51). Milestones 0–24 COMPLETE. Milestone 25 IN PROGRESS — TDD testing rebuild (Phase 112.2+). **All 7 gates GREEN.** 443 unit tests (74 suites). E2E: 108 passed, 0 failed, 25 skipped. Coverage: 78.55/66.3/83.53/78.85. Active TDs: TD-HARDCODE-01 (HIGH), TD-WCAG-06 (HIGH), TD-REUSE-04/WCAG-05/WCAG-07/TEST-02 (MEDIUM). Build passing. Node.js 24.12.0.
...
> Last updated: PM audit #51 (2026-03-24).

### Active — HIGH Priority

| ID             | Area    | Description                                                                                                                                              | Phase |
| -------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| TD-HARDCODE-01 | Content | Stop reason messages in `src/constants/stop-reasons.ts` are hardcoded user-facing copy. Must be admin-configurable via `effective-*` pattern. Phase 107. | 107   |
| TD-WCAG-06     | A11y    | ~20 components have decorative `<i className="bi bi-*">` icons missing `aria-hidden="true"`. Screen readers announce empty content. Phase 109.           | 109   |
