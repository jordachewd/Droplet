...
- ALWAYS check and use available MCPs for documentation first.
- ALWAYS check and use available skills first for performing tasks.
...
10. **All features (image, audio) available in all plans and all personas** — differentiated by plan limits (quantity) and persona purpose (prompt context). No feature is plan-exclusive or persona-exclusive. Video generation has been removed from the product (owner directive, PM audit #85).
