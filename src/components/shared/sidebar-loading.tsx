...
export default function SidebarLoading() {
  return (
    <aside
      className="SidebarLoading app-sidebar lg:w-56"
      aria-label="Loading sidebar"
      aria-busy="true"
    >
      <div className="SidebarLoadingHead flex w-full items-center px-4 py-3">
        <div className="h-8 w-8 animate-pulse rounded-full bg-lavenderHaze-300 dark:bg-nightIndigo-600"></div>
      </div>

      <div className="SidebarLoadingBody flex min-h-0 flex-1 flex-col gap-6 px-3 py-4">
