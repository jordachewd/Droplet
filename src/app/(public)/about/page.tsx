    ...
    <>
      ...
      {aboutSections.map((section, index) => (
        <PublicSection
          ...
          sectionClass={`about-section-${index}`}
          wrapperClass={`about-wrapper-${index}`}
        >
          <ContentCard eyebrow={section.eyebrow} title={section.title}>
      ...
      <CtaBannerSection
        id="about-cta-banner"
        copy={{
          ctaHeading: aboutContent.ctaTitle,
          ctaDescription: aboutContent.ctaDescription,
          ctaPrimaryLabel: aboutContent.ctaPrimaryLabel,
          ctaPrimaryLink: "/plans",
          ctaSecondaryLabel: aboutContent.ctaSecondaryLabel,
          ctaSecondaryLink: "/personas",
        }}
      />
    </>
  );
