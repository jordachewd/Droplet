...
The execution order is: **CRITICAL production bugs (stream + payment) → admin configurability promo text → env hardening → performance (config cache) → remaining backlog.**
